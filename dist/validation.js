...
function () {
  function Validation() {
    ...
    __chunk_1._classCallCheck(this, Validation);
  ...
  __chunk_1._createClass(Validation, [{
    key: "toString",
    ...
    value: function toString() {
      ...
      return "".concat(annotations).concat(this.state, " ").concat(type, "value ").concat(utils.stringify(this.value));
    }
    /**
    ...
    key: "delegate",
    value: function delegate(errors$$1) {
      this.errors.delegate(errors$$1);
      return this;
    }
  }, {
    key: "succeed",
